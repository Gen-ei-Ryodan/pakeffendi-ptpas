                                    ...
                                    <div class="border rounded p-3">
                                        <div class="d-flex justify-content-between align-items-start">
                                            ...
                                            <div class="d-flex gap-2 flex-shrink-0">
                                                ...
                                                <form method="POST" action="{{ route('guest.profile.my-customers.addresses.destroy', [$myCustomer, $addr]) }}" data-ajax="false" onsubmit="return confirm('Hapus alamat ini?')">
                                                    @csrf
                                                    @method('DELETE')
    ...
    document.querySelectorAll('.edit-addr-btn').forEach(function(btn) {
        btn.addEventListener('click', function() {
            ...
            editModal.addEventListener('shown.bs.modal', function() {
                // Need to destroy previous cascade init
