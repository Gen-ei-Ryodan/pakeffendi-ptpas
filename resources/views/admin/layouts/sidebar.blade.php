...
<aside class="w-72 bg-white border-r border-slate-200 px-4 py-5 overflow-y-auto">
    ...
    <div class="px-2 space-y-5">
        @foreach ($groups as $groupName => $items)
            <div>
                <div class="text-xs uppercase tracking-wider text-slate-500 mb-2">{{ $groupName }}</div>
                <nav class="space-y-1">
