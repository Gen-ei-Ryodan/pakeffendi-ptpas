...
<div class="max-w-4xl mx-auto">
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
        ...
        <form method="post" action="{{ route('admin.customers.update', $customer) }}" class="p-6 space-y-8" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="url" name="google_maps_url" value="{{ old('google_maps_url', $customer->google_maps_url) }}"
                               class="w-full rounded-lg border border-slate-300 px-3.5 py-2.5 text-sm focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20 transition-shadow placeholder-slate-400"
                ...
                <div class="mt-4">
                    ...
                    @if($customer->store_photo_path)
                        <div class="mt-2 flex items-center gap-3">
                            <img src="{{ asset('storage/'.$customer->store_photo_path) }}" alt="Foto Toko" class="w-20 h-20 object-cover rounded-lg border">
                            <span class="text-xs text-slate-400">Upload foto baru untuk mengganti</span>
                        </div>
                    @endif
