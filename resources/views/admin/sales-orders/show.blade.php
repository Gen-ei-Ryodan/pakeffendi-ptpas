...
@section('content')
    <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex items-center gap-2">
            ...
            <button type="button" onclick="printNota('{{ route('admin.sales-orders.print', $order) }}')" class="px-4 py-2 rounded-lg border border-slate-200 hover:bg-slate-100 font-semibold">
