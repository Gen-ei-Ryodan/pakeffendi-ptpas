            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <select name="status_product" class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                            ...
                            @foreach(\App\Models\ProductStatus::orderBy('sort_order')->get() as $s)
                                <option value="{{ $s->code }}" @selected(old('status_product', $product->status_product) === $s->code)>{{ $s->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="min_multiply_qty" value="{{ old('min_multiply_qty', $product->min_multiply_qty ?? 1) }}" min="0" class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                    ...
                    <div>
                        ...
                        <input name="min_multiply_notes" value="{{ old('min_multiply_notes', $product->min_multiply_notes) }}" maxlength="50" placeholder="Contoh: 1 box isi 10" class="w-full rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                    </div>
                    <div></div>
                </div>
            </div>
